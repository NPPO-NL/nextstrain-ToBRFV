...
Tomato brown rugose fruit virus (ToBRFV) is a Tobamovirus that was first observed in 2014 and 2015 on tomato plants in Israel and Jordan respectively. Since the first description, the virus has been reported from all continents except Antarctica, and has been found infecting both tomato and pepper crops.
...
### Other builds from NPPO-NL
[Go to the NPPO-NL Nextstrain website](https://nextstrain.nrcnvwa.nl/)
...
[**4 August 2025**](https://nextstrain.nrcnvwa.nl/ToBRFV/20250804)

Shows 455 genomic sequences from 32 countries from materials sampled between November 2014 and January 2025. All sequences are now trimmed relative to the coding sequence of [KT383474.1](https://www.ncbi.nlm.nih.gov/nuccore/KT383474) and substitutions are correctly visualized. Sequence [MK165457.1](https://www.ncbi.nlm.nih.gov/nuccore/MK165457) was removed due to indels in the RdRp CDS. The phylogenetic tree was generated with IQ-TREE using the GTR model and UFBoot with 1000 bootstrap replicates. The confidence level and municipality can now be selected in the Color By dropdown menu. Additionally, the auspice configuration file was updated to the new format.
...
For each update a resource announcement is published. When referring to a certain ToBRFV build, please cite the original paper, and the relevant resource announcement.
 ...
 - *De Koning PPM et al. [(2025)](https://doi.org/10.1094/PHYTOFR-05-24-0049-A)Tomato brown rugose fruit virus Nextstrain build version 4: pathways of introduction and local spread*
 - *Oplaat C et al. [2026]Tomato brown rugose fruit virus (ToBRFV) Nextstrain build v5 (in prep.)*
